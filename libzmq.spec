...
Source0  : https://github.com/zeromq/libzmq/releases/download/v4.2.3/zeromq-4.2.3.tar.gz
...
%package abi
Summary: abi components for the libzmq package.
Group: Default

%description abi
abi components for the libzmq package.
...
export LANG=C
export SOURCE_DATE_EPOCH=1542246820
